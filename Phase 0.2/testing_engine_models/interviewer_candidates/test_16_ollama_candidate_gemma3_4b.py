"""
TEST 16: gemma3:4b — Interviewer role, CANDIDATE
====================================================
What it shows:
  - Whether Ollama has this model pulled
  - Load + generation speed for Gemma 3 4B as a candidate interviewer
    model. At Q4 this is ~2.9 GB — comfortable headroom on a 6 GB card.
...
Run:
  python interviewer_candidates/test_16_ollama_candidate_gemma3_4b.py
"""
...
def run_test():
    print(f"TEST 16: {MODEL} (interviewer — candidate)")
    print("=" * 50)
