"""
TEST 14: mistral:7b — Interviewer role, CANDIDATE
====================================================
What it shows:
  - Whether Ollama has this model pulled
  - Load + generation speed for Mistral 7B as a candidate interviewer
    model. At Q4 this is ~4.4 GB — comfortable headroom on a 6 GB card.
...
Run:
  python interviewer_candidates/test_14_ollama_candidate_mistral_7b.py
"""
...
def run_test():
    print(f"TEST 14: {MODEL} (interviewer — candidate)")
    print("=" * 50)
