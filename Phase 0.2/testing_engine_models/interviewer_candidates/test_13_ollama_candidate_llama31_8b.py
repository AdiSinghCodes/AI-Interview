"""
TEST 13: llama3.1:8b — Interviewer role, CANDIDATE
====================================================
What it shows:
  - Whether Ollama has this model pulled
  - Load + generation speed for Llama 3.1 8B as a candidate interviewer
    model. At Q4 this is ~5.0 GB — tight on a 6 GB card, little room
    left for KV cache on long interview transcripts.
...
Run:
  python interviewer_candidates/test_13_ollama_candidate_llama31_8b.py
"""
...
def run_test():
    print(f"TEST 13: {MODEL} (interviewer — candidate)")
    print("=" * 50)
